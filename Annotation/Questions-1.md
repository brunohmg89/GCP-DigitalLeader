...
2. What are the key features of Google Cloud Identity?<br>
    ...
    > _- Uma plataforma unificada de gerenciamento de identidade, acesso, aplicativos e endpoints (IAM/EMM)._
    > _- Dê aos usuários acesso fácil a aplicativos com logon único._
    > _- A autenticação multifator protege os dados do usuário e da empresa._
